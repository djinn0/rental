...
function generateSelectorNavBar() {
    ...
    var e1 = '<li class="navigation-element">&#9968</li>';
    var e2 = '<li class="navigation-element"><a href="index.html">Escapade Outfitters 1</a></li>';
...
function generateMobileNavBar(){
    ...
    var b = document.getElementsByTagName("body")[0];
    var e1 = "<a class='test' href='menu.html'>Place Holder 1</a>";
    var e2 = "<a class='test' href='recent.html'>Place Holder 3</a>";
    var e3 = "<a class='test' href='ArticleList3.html'>Place Holder 3</a>";
    var e4 = "<a class='test' href='gridPractice2.html'>Place Holder 4</a>";
    b.insertAdjacentHTML('afterbegin', "<details class='navigation'><summary class='navigation'><a href='index.html'>Ahoy &#9096</a></summary><div>" + e1 + e2 + e3 + e4 + "</div></details>");
    }
