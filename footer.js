...
function generateFooter()
{
  ...
  let anchor = '<div id="mountain">' + "\u26F0"; + '</div>'; 
  ...
  */
  ...
  var sf2 = '#mountain{color: white; font-size: 1.75em; text-align: center;}';
  ...
  var sm2 = '#mountain{color: white; font-size: 6vmin; text-align: center;}';
